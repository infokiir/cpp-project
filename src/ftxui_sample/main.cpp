...
// configuration step. It creates a namespace called `cpp_project`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cpp_project::cmake::project_name, cpp_project::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cpp_project::cmake::project_version);
      return EXIT_SUCCESS;
    }
